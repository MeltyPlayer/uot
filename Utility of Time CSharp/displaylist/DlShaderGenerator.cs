  ...
  public class DlShaderGenerator {
    ...
    private int CreateFragmentShader_(
      ...
      var fragmentMainLines =
          @"vec4 applyLighting(vec4 inputColor) {
              ...
              vec3 finalColor = mergedColor * inputColor.rgb;
            ...
            vec4 calculateCcmuxColor(void) {
              ...
              vec4 Texel0 = texture(texture0, v_uv0);
              vec4 Texel1 = texture(texture1, v_uv1);" +
          newLine;
      ...
      fragmentMainLines +=
          ...
          void main(void) {
            ...
            outColor = mix(ccmuxColor, applyLighting(ccmuxColor), lightingEnabled);
          }";
