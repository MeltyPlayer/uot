...
namespace UoT {
  static class RDP_Defs {
    ...
    public static double[] FIXED2FLOATRECIP = new double[] {
    ...
    public static string[] ColorDStr = new string[] {
        "cCOMBINED", "cTEXEL0", "cTEXEL1", "cPRIM", "cSHADE", "cENV", "1.0",
        "0.0"
    };

    public static string[] AlphaAStr = new string[] {
        "aCOMBINED", "aTEXEL0", "aTEXEL1", "aPRIM", "aSHADE", "aENV", "1.0",
        "0.0"
    };

    public static string[] AlphaBStr = new string[] {
        "aCOMBINED", "aTEXEL0", "aTEXEL1", "aPRIM", "aSHADE", "aENV", "1.0",
        "0.0"
    };

    public static string[] AlphaCStr = new string[] {
        "LODFRAC", "aTEXEL0", "aTEXEL1", "aPRIM", "aSHADE", "aENV",
        "PRIMLODFRAC", "0.0"
    };

    public static string[] AlphaDStr = new string[] {
        "aCOMBINED", "aTEXEL0", "aTEXEL1", "aPRIM", "aSHADE", "aENV", "1.0",
        "0.0"
    };
    ...
    public static uint[] G_COMBINERMUX1 = {
      ...
      0xFFFFF9F8, 0xFFFFF9F8, 0x1F10FDFF, 0xFF0FF3FF, 0xFFFFFFF8, 0x1F0CFFFF,
      0x350CF37F, 0xFFFFF9F8, 0x1FFCFDF8
    };
  
        public static Structs.DLCommand FindLinkedCommand(Structs.N64DisplayList DL, byte Command, int StartIndex) {
      for (int i = StartIndex, loopTo = DL.Commands.Length - 1; i <= loopTo; i++) {
        if (DL.Commands[i].CMDParams[0] == Command) {
          return DL.Commands[i];
        } else if (i > StartIndex & DL.Commands[i].CMDParams[0] == (int)F3DEX2_Defs.F3DZEX.VTX) {
          return default;
        }
      }
